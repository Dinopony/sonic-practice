...
namespace md
{
    ...
    public:
        ...
        Code& addq(uint8_t value, const Param& Rx, Size size);
        Code& addqb(uint8_t value, const Param& Rx) { return this->addq(value, Rx, Size::BYTE); }
        Code& addqw(uint8_t value, const Param& Rx) { return this->addq(value, Rx, Size::WORD); }
        Code& addql(uint8_t value, const Param& Rx) { return this->addq(value, Rx, Size::LONG); }

        Code& subq(uint8_t value, const Param& Rx, Size size);
        Code& subqb(uint8_t value, const Param& Rx) { return this->subq(value, Rx, Size::BYTE); }
        Code& subqw(uint8_t value, const Param& Rx) { return this->subq(value, Rx, Size::WORD); }
        Code& subql(uint8_t value, const Param& Rx) { return this->subq(value, Rx, Size::LONG); }
        ...
        Code& move_to_sr(uint16_t value);
        ...
        Code& divu(uint16_t value, const DataRegister& dx) { return this->divu(wval_(value), dx); }
        ...
        Code& lea(const Param& value, const AddressRegister& to);
